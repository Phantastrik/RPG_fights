...
class Monster extends Personnage
{
    ...
    {
        $res = new Monster($this->name, $this->niveau);
        $res->attaque = $this->attaque;
        $res->defense = $this->defense;
        $res->vitesse = $this->vitesse;
        $res->sagesse = $this->sagesse;
        $res->pv      = $this->pv;
        $res->pvMax   = $this->pvMax;
        $res->pm      = $this->pm;
        $res->pmMax   = $this->pmMax;
        $res->statSpreadValue = $this->statSpreadValue;
        $res->abilities = $this->abilities;
        return $res;
    }
